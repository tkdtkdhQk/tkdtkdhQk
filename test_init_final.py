...
def init():
	...
	### 채널 고정###
	basicSetting[6] = int('698602692473520159') #보이스채널ID
	basicSetting[7] = int('698602627696689232') #택스트채널ID
...
async def on_ready():
	...
	await client.change_presence(status=discord.Status.dnd, activity=discord.Game(name="!명치=재시작 입니다.", type=1), afk=False)
